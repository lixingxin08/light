<template>
    <div>
        <div class="flexrow" style="justify-content: flex-end;padding: 20px;">

          <a-button type='primary' style="margin-right: 10px;">新增</a-button>
          <a-button type='primary'>删除</a-button>
        </div>
        <a-table :scroll="{  y: 650 }" :row-selection="{ selectedRowKeys: selectedRowKeys, onChange: onSelectChange }"
